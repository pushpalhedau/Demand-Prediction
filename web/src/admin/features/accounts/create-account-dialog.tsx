...
import { CURRENCY_SYMBOLS, LANGUAGES, REGION_LABELS } from "@/admin/lib/constants";
import { setFlash } from "@/admin/lib/flash";
import type { CreatedCredentials } from "@/admin/lib/types";
...
export function CreateAccountDialog() {
  ...
  const create = useMutation({
    ...
    onSuccess: async (created, variables) => {
      ...
      setOpen(false);
      router.push(`/admin/accounts/${created.slug}`);
    },
