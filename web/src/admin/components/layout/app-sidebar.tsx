...
import { NAV, navForPath } from "@/admin/lib/nav";
import type { Operator } from "@/admin/lib/session";
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader className="h-14 justify-center border-b px-4 group-data-[collapsible=icon]:px-2">
        <Link href="/admin" className="flex items-center" aria-label="PredictaX Admin">
