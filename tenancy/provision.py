...
from database.connection import get_admin_session
...
def create_tenant(slug: str, name: str, admin_email: str, admin_password: str = None,
    ...
    try:
        ...
        if create_login:
            ...
            try:
                supabase.admin_create_user(admin_email, password, tenant_id, role="tenant_admin")
            except Exception:
...
def add_user(slug: str, email: str, password: str = None, role: str = "tenant_user") -> dict:
    ...
    supabase.admin_create_user(email, password, tenant_id, role=role)
...
def create_operator(email: str, password: str = None) -> dict:
    ...
    supabase.admin_create_user(email, password, tenant_id=None, role="platform_admin")
